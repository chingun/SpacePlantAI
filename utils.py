...
from torchvision.models import resnet50, densenet121, densenet169, mobilenet_v2, efficientnet_b4, vit_b_16
...
def get_spaceplant_model(args, n_classes):
    model_dict = {'resnet50': resnet50, 'densenet121': densenet121, 'efficientnet': efficientnet_b4, 'vit': vit_b_16}
    model = model_dict[args.model](pretrained=False, num_classes=n_classes)
    return model
