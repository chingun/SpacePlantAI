...
from utils import set_seed, load_model, save, get_spaceplant_model, update_optimizer, get_data
...
def train(args):
    ...
    model = get_spaceplant_model(args, n_classes=dataset_attributes['n_classes'])
