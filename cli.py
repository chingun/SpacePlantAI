...
def _add_training_parser(parser):
    ...
    group_training.add_argument('--batch_size', type=int, default=64 , help='default is 256')
...
def _add_model_parser(parser):
    ...
    group_model.add_argument('--model', choices=['resnet50', 'densenet121', 'densenet169', 'mobilenet_v2', 'inception_resnetv2', 'efficientnet', 'vit'],
                             default='vit', help='choose the model you want to train on')
...
def _add_dataset_parser(parser):
    ...
    group_dataset.add_argument('--size_image', type=int, default=224,
